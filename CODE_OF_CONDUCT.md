...
(issues, pull requests, discussions), and also applies when an individual
is officially representing the community in public spaces.

## Enforcement

This project does not yet have a dedicated project email address for
reports. Instances of abusive, harassing, or otherwise unacceptable
behavior may be reported by opening a private security advisory on this
repository's GitHub **Security** tab (see [SECURITY.md](SECURITY.md) for
the exact steps) — GitHub's private reporting mechanism works for conduct
reports as well as for vulnerability reports, and keeps the report visible
...
[https://www.contributor-covenant.org/faq][faq]. Translations are
